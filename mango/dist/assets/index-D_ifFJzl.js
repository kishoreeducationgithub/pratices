...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wo(e,t,n){let r=new Float32Array(lo),i=new W(0,1,0);return new Vi({name:`SphericalGaussianBlur`,defines:{n:lo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Do(),fragmentShader:`
	...
	`}var Oo=class extends rn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new J(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `}));t.renderOrder=-100,t.frustumCulled=!1,e.add(t)}function yl(e){let t=new Ma(16774364,1.2);e.add(t);let n=new ja(16777215,3.25);n.position.set(-4.2,5.4,5.8),n.castShadow=!0,n.shadow.mapSize.set(1536,1536),n.shadow.camera.near=.5,n.shadow.camera.far=18,n.shadow.camera.left=-7.5,n.shadow.camera.right=7.5,n.shadow.camera.top=5.5,n.shadow.camera.bottom=-4.8,e.add(n);let r=new Oa(16760120,17,16,1.75);r.position.set(4.8,2.4,-3.8),e.add(r);let i=new Oa(10485690,3.1,13,2.1);i.position.set(-4.2,-1.65,2.7),e.add(i)}function bl(e){let t=new si(new ji(12.8,4.2),new Mi({color:8012052,opacity:.18,transparent:!0}));t.position.set(0,-2.08,-.1),t.rotation.x=-Math.PI/2,t.receiveShadow=!0,e.add(t)}function xl(e){let t=new Rr,n=new Float32Array(450);for(let e=0;e<150;e+=1)n[e*3]=(Math.random()-.5)*12,n[e*3+1]=(Math.random()-.5)*5.8,n[e*3+2]=-3+Math.random()*4;t.setAttribute(`position`,new Cr(n,3));let r=new wi(t,new yi({color:16761419,size:.04,transparent:!0,opacity:.32,depthWrite:!1,blending:2}));return e.add(r),r}var Sl=new pa;async function Cl(e,t){let[n,r]=await Promise.all([Sl.loadAsync(e),Sl.loadAsync(t)]);return n.colorSpace=qe,n.anisotropy=8,n.minFilter=y,n.magFilter=_,r.colorSpace=``,r.anisotropy=4,r.minFilter=y,r.magFilter=_,{texture:n,depthMap:r}}async function wl(e,t,n,r={}){let{texture:i,depthMap:a}=await Cl(e,t),o=i.image.width/i.image.height,s=2.84*(r.scale||1),c=new si(new ji(s*o,s,160,160),new Wi({map:i,alphaMap:gl(),displacementMap:a,displacementScale:r.displacementScale??.36,transparent:!0,alphaTest:.5,roughness:.48,metalness:.08,clearcoat:.46,clearcoatRoughness:.23,side:2}));return c.position.fromArray(n),c.rotation.set(Lt.degToRad(r.rotationX??0),Lt.degToRad(r.rotationY??0),r.rotationZ??0),c.castShadow=!0,c.receiveShadow=!0,c.userData={basePosition:c.position.clone(),baseRotation:c.rotation.clone(),phase:r.phase??0,rotateSpeed:r.rotateSpeed??.005,floatAmp:r.floatAmp??.2},c}function Tl(e,t){e.traverse(e=>{!e.isMesh&&!e.isPoints||(e.geometry?.dispose(),(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{e&&(Object.values(e).forEach(e=>{e?.isTexture&&e.dispose()}),e.dispose())}))}),t.dispose()}function El(){let e=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let t=e.current;if(!t)return;let n=0,r=!1,i=new Fn,a=new U(0,0),o=new U(0,0),{scene:s,camera:c,renderer:l}=_l(t);vl(s),yl(s),bl(s);let u=xl(s);s.add(i);async function d(){let e=await Promise.all(hl.map((e,t)=>wl(e.texturePath,e.depthPath,e.position,{scale:e.scale,phase:e.phase,rotationX:t%2==0?4:-4,rotationY:(t-2.5)*4,rotationZ:e.rotationZ,rotateSpeed:.0038+t*55e-5,floatAmp:.16+t%3*.035,displacementScale:.3+t%3*.04})));if(r){e.forEach(e=>{e.geometry.dispose(),e.material.dispose()});return}e.forEach(e=>i.add(e))}function f(e){let t=l.domElement.getBoundingClientRect();o.x=(e.clientX-t.left)/t.width*2-1,o.y=-((e.clientY-t.top)/t.height*2-1)}function p(){let e=t.clientWidth||window.innerWidth,n=t.clientHeight||window.innerHeight;c.aspect=e/n,c.updateProjectionMatrix(),l.setSize(e,n)}function m(){n=requestAnimationFrame(m);let e=performance.now()*.001;a.lerp(o,.045),i.children.forEach((t,n)=>{let{basePosition:r,baseRotation:i,phase:o,rotateSpeed:s,floatAmp:c}=t.userData;t.position.x=r.x+Math.sin(e*.38+o)*.08,t.position.y=r.y+Math.sin(e*.82+o)*c,t.position.z=r.z+Math.cos(e*.55+o)*.09,t.rotation.y=i.y+e*s+Math.sin(e*.48+o)*.15+a.x*.09,t.rotation.x=i.x+Math.sin(e*.68+o)*.08-a.y*.05,t.rotation.z=i.z+Math.cos(e*.4+o)*.035,t.material.displacementScale=Lt.lerp(t.material.displacementScale,.34+Math.sin(e*.55+n)*.03,.035)}),u.rotation.y=e*.025,u.rotation.x=Math.sin(e*.2)*.045,c.position.x=Lt.lerp(c.position.x,a.x*.48,.035),c.position.y=Lt.lerp(c.position.y,.82+a.y*.25,.035),c.position.z=Lt.lerp(c.position.z,8.7+a.y*.05,.035),c.lookAt(a.x*.18,a.y*.08,0),l.render(s,c)}l.domElement.addEventListener(`pointermove`,f);let h=new ResizeObserver(p);return h.observe(t),d(),m(),()=>{r=!0,cancelAnimationFrame(n),h.disconnect(),l.domElement.removeEventListener(`pointermove`,f),l.domElement&&t.contains(l.domElement)&&t.removeChild(l.domElement),Tl(s,l)}},[]),(0,ml.jsxs)(`main`,{className:`mango-stage`,children:[(0,ml.jsx)(`div`,{className:`mango-scene`,ref:e,"aria-label":`Animated pseudo-3D floating mangoes`}),(0,ml.jsxs)(`div`,{className:`studio-label`,children:[(0,ml.jsx)(`span`,{children:`Displacement Studio`}),(0,ml.jsx)(`strong`,{children:`Floating Mangoes`})]})]})}function Dl(){return(0,ml.jsx)(El,{})}(0,u.createRoot)(document.getElementById(`root`)).render((0,ml.jsx)(l.StrictMode,{children:(0,ml.jsx)(Dl,{})}));